...
const Styles = {
	...
	icon: "text-2xl text-zinc-300 duration-300 group-hover:opacity-0",
	title: "text-md text-center font-thin text-zinc-300 duration-300 group-hover:-translate-y-14",
